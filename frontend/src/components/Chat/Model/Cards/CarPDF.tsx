    ...
    <Document>
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>Generated by AI Car Advisor on {new Date().toLocaleDateString('en-IN')}</Text>
          <Text style={styles.footerText}>For more details, visit our website: https://www.aicaradvisor.com/</Text>
        </View>
      </Page>
