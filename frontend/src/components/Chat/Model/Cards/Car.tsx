  ...
  */
  ...
  const [showSignUpState, setshowSignUpState] = useState<boolean>(false);
    ...
    useEffect(() => {
      ...
      //   try {
      //     const response = await axiosInstance1.get('/api/cargpt/recommended_variants/');
      //     setRecommendedCars(response.data.data.VariantDetails);
      //   } catch (error) {
  ...
  const CustomNextArrow = (props: any) => {
    ...
    return (
      ...
      sx={{
        ...
        fontSize: 30,
        cursor: "pointer",
        right: -20, // Adjusted from 5 to -20
        zIndex: 10,
        top: '50%', // Adjusted from 40% to 50%
    ...
    return (
      <ArrowBackIosNewIcon
        ...
        sx={{
          ...
          fontSize: 30,
          cursor: "pointer",
          left: -25, // Adjusted from -20 to -30
          zIndex: 10,
           "&:hover": {
            color: mode === "dark" ? "#ddd" : "#222", // Custom hover color
          },
    ...
    >
      ...
      >
        ...
        {recommendedCars.length > 0 && (
          <Box mt={4}>
            <Typography variant="h6" fontWeight="bold" sx={{ mb: 1, mt:0, px:3, py:0.5,  borderRadius: "8px", color: mode === "dark" ? "#fff" : "black", fontSize: "25px" }}>
             Similar Cars
            </Typography>
            <Slider {...settings}>
