...
const Header: React.FC = () => {
  const [cookies, setCookie, removeCookie] = useCookies([
    ...
    "selectedOption",
    "currentCity",
    "locationPermissionAcknowledged", // New cookie to track acknowledgment
  ]);
  ...
  return (
    <AppBar
      ...
      sx={{
        backgroundColor:
          mode === "dark" ? theme.palette.background.paper : "#f5f6fa",
        boxShadow: "0 2px 5px rgba(0,0,0,0.1)",
        // pb: 1,
        // Add small gap below Android status bar; add safe area for iOS
        pt: isAndroid
          ? theme.spacing(1)
          : `calc(${theme.spacing(0)} + env(safe-area-inset-top, 0px))`,
      }}
    >
      <Toolbar
        sx={{
      ...
      >
        ...
        >
          ...
          >
            ...
            <Box sx={{ fontSize: 14, color: mode == "dark" ? "#fff" : "#333" }}>
      ...
      <AskLocation show={locationDenied} onClose={onCLoseLocationPopup} onAcknowledge={handleLocationAcknowledge} />
      <CityInputForm
